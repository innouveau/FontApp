...
var this_color = get_parameters("color", "100,0,0,0");

var textfield = new Array ();
textfield[1] = { id: get_parameters("id", 294), size: get_parameters("size", 180), line: get_parameters("line", 50), align: get_parameters("align", "left"), color: this_color, focus: 0 }
